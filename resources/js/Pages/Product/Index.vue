                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between py-2 px-4"
                            ...
                            <ul class="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
                                <li>
                                    <a href="#"
                                        class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 hover:text-gray-700">Previous</a>
                                </li>
                                <li>
                                    <a href="#"
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center justify-center px-3 h-8 leading-tight text-stone-400 hover:text-stone-400 cursor-not-allowed">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
